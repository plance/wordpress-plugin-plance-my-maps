...
const PATH          = __DIR__;
const VERSION       = '1.1.0';
const SECURITY      = 'plance_plugin_my_maps__xyz';
const FIELD_API_KEY = '_plance_plugin_my_maps_api_key';

define( 'PLANCE_PLUGIN_MY_MAPS_URL', rtrim( plugin_dir_url( __FILE__ ), '/' ) );
